 ...
 */
public class Alien5 extends Actor
{
    /**
     * Act - do whatever the Alien5 wants to do. This method is called whenever
    ...
    public void act()
    {
       ...
       // }
        ...
        getWorld().addObject(new Alien5(), Greenfoot.getRandomNumber(300), 0);
        getWorld().removeObject(this);
        }
    }
}
